    ...
    <div className="game-2048">
      ...
      <div className="main-buttons" style={{ marginBottom: "2em" }}>
        <button
          ...
          id="menu"
          onClick={(t) => props.changeAppState(t)}
        >
          main menu
        </button>
        <button
      ...
      <Grid
        ...
        setScoreFormVisible={setScoreFormVisible}
        ...
        pieces={pieces}
        setPieces={setPieces}
        loadGameVisible={loadGameVisible}
        setLoadGameVisible={setLoadGameVisible}
        scoreSubmitted={scoreSubmitted}
        scoreFormVisible={scoreFormVisible}
        setHighlightId={setHighlightId}
      />
      <Footer
        setNotification={props.setNotification}
        handleScoreSaveClick={handleScoreSaveClick}
        grid={grid}
        pieces={pieces}
        gameOver={gameOver}
        score={currentScore}
