  ...
  return (
    <div className="leaderboards">
      ...
      <div
        ...
        style={{ height: "70vh", marginBottom: "30vh", position: "relative" }}
      >
        <div id="menu" onClick={changeAppState} className="exit-button">
          ×
        </div>
        ...
        <div className="buttons">
          {currLeaderboard === "snake" ? (
            <SnakeButtons
              leaderboardState={currGameMode}
              setLeaderboardState={setCurrGameMode}
            />
          ) : (
            currLeaderboard === "puzzle" && (
              <PuzzleButtons
