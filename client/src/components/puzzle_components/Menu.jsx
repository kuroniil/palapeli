    ...
    <div className="menu-base">
      ...
      >
        <MenuDetails
          ...
          handleModesClick={handleModesClick}
          handleGuideClick={handleGuideClick}
          handleMenuClick={props.handleMenuClick}
          changeAppState={props.changeAppState}
        />
        <div
          className={`modes-details-wrapper ${
            props.modesTabVisible ? "visible" : "hidden"
          }`}
        >
          <ModesTab
        ...
        <div
          className={`guide-details-wrapper ${
            props.guideVisible ? "visible" : "hidden"
          }`}
        >
