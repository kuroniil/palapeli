  ...
  return (
    <div
      className={`characters-wrapper ${
        charactersMenuVisible ? "visible" : "hidden"
      }`}
    >
      <div
        onClick={() => setCharactersMenuVisible(false)}
      ...
      <div className="menu">
        ...
        <button id="default" onClick={handleCharacterClick}>
          default
        </button>
        <button id="orange" onClick={handleCharacterClick}>
          orange
        </button>
        <button id="green" onClick={handleCharacterClick}>
          green
        </button>
      </div>
    </div>
